...
const createTemple = () => {
    ...
    document.querySelector('main').innerHTML =
        ...
        <p><b>order id: </b>${orderId}</p><br><p><b>total price: </b>${totalPrice}</p></div><section>${products.map(productTemplate).join('')}</section><a href="index.html"><button class="orange-button">go back the home page</button></a>`
    localStorage.clear()
}
